...
const NAV: Record<string, { label: ActiveTab; icon: string }[]> = {
    admin: [
        { label: 'Dashboard', icon: '📊' }, { label: 'POS', icon: '🧾' }, { label: 'Inventory', icon: '📦' },
        { label: 'Procurement', icon: '🚚' }, { label: 'Workforce', icon: '👥' }, { label: 'Payroll', icon: '💰' },
        { label: 'Analytics', icon: '📈' }, { label: 'Notifications', icon: '🔔' }, { label: 'UserManagement' as ActiveTab, icon: '⚙️' },
        { label: 'Settings', icon: '👤' },
    ],
    manager: [
        { label: 'Dashboard', icon: '📊' }, { label: 'POS', icon: '🧾' }, { label: 'Inventory', icon: '📦' },
        { label: 'Procurement', icon: '🚚' }, { label: 'Workforce', icon: '👥' }, { label: 'Notifications', icon: '🔔' },
        { label: 'Settings', icon: '👤' },
    ],
    seller: [
        { label: 'POS', icon: '🧾' }, { label: 'Inventory', icon: '📦' }, { label: 'Workforce', icon: '👥' }, { label: 'Notifications', icon: '🔔' },
        { label: 'Settings', icon: '👤' },
    ],
    staff: [
        { label: 'Workforce', icon: '👥' }, { label: 'Payroll', icon: '💰' }, { label: 'Notifications', icon: '🔔' },
        { label: 'Settings', icon: '👤' },
    ],
};
